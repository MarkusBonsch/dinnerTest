...
excel_file = pd.ExcelFile('dinnerTest20HighIntolerance.xlsx')
...
myEvent = dinnerEvent(dinnerTable = dinner, 
                      ...
                      dinnerTime=dinnerTime, travelMode='simple')

test = myEvent.assign(repCourseAssign = 10, repTableAssign = 10, outFolder='res20HighIntolerance', overwrite = True)
